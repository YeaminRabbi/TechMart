                ...
                <div class="container">
                    ...
                    <div id="primary" class="content-area">
                        <main id="main" class="site-main">
                            ...
                            @forelse($blogs_coronavirus as $blog)
                                ...
                                <div class="content-body">
                                    <header class="entry-header">
                                        ...
                                        <div class="entry-meta">
                                            ...
                                            <span class="posted-on"><time class="entry-date published" datetime="2016-03-01T07:40:25+00:00">{{$blog->created_at}}</time> <time class="updated" datetime="2016-03-04T18:46:11+00:00" itemprop="datePublished">March 4, 2016</time></span>
                                        </div>
                                    </header><!-- .entry-header -->
                    ...
                    <div id="sidebar" class="sidebar-blog" role="complementary">
                        {{-- <aside id="search-2" class="widget widget_search">
                            <form role="search" method="GET" class="search-form" action="{{route('blog-search')}}">
                                ...
                                <label>
                                    ...
                                    <input type="text" class="search-field" placeholder="Search by blog name &hellip;"  name="search" />
                                </label>
                        ...
                        <aside class="widget widget_categories">
                            ...
                            <ul>
                                ...
                                <li class="cat-item"><a href="{{route('fashion')}}" >Fashion</a></li>
                                <li class="cat-item"><a href="{{route('gadget')}}" >Gadget</a></li>
                                <li class="cat-item"><a href="{{route('health')}}" >Health</a></li>
                                <li class="cat-item"><a href="{{route('internationalnews')}}" >international</a></li>
                                <li class="cat-item"><a href="{{route('job')}}" >Job</a></li>
                                <li class="cat-item"><a href="{{route('lifestyle')}}" >Lifestyle</a></li>
                                <li class="cat-item"><a href="{{route('politics')}}" >Politics</a></li>
