                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div>
                                                ...
                                                <form action="{{ route('attribute_update_features') }}" method="POST" style="border:1px solid black;padding:15px;margin-top:2px;">
                                                    @csrf
                                                    ...
                                                    <div class="row mg-t-20 attri">
                                                        ...
                                                        <div class="col-sm-1 mg-t-10 mg-sm-t-0">
                                                            <select name="ram" id="asd" class="form-control selectpicker">
                                                                ...
                                                                <option value="64GB" {{("64GB" == $products->ram) ? 'selected' : ''}}>64GB</option>
                                                                <option value="2GB" {{("2GB" == $products->ram) ? 'selected' : ''}}>2GB</option>

                                                                <option value="NULL" {{("NULL" == $products->ram) ? 'selected' : ''}}>NULL</option>
                                                            </select>
                                                        </div>
                                                ...
                                                <a  href="{{route('admin.features.edit' , $product->id)}}" style="color: white;" class="btn btn-dark m-2">Back </a>
                                            </div>
                                        </div>
                                ...
                                <div class="card-box">
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            ...
                                            <form action="{{ route('attribute_add_features') }}" method="POST">
                                                @csrf
                                                ...
                                                <div style="margin-top: 30px;">
                                                    <button type="submit" name="submit" class="btn btn-success" >Add Attributes</button>
                                                        ...
                                                        <a  href="{{route('admin.features.list')}}"  class="btn btn-dark m-2" > Product List </a>
