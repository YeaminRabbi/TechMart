                            ...
                            <div class="col-12">
                                <div class="card-box">
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div>
                                                <form action="{{route('admin.features.update')}}" enctype="multipart/form-data" method="POST">
                                                    @csrf
                                                    ...
                                                    <a href="{{ route('admin.features.list') }}" class="btn btn-dark">Back
                                                    </a>
                                                    <button type="submit" name="submit" class="btn btn-primary">Update Product Details</button>
                                                    <a href="{{ route('admin.features.attribute.edit', $products->id) }}" class="btn btn-warning">
