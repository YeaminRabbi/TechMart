                ...
                <div class="container">
                    ...
                    <div id="primary" class="content-area">
                        <main id="main" class="site-main">
                            ...
                            @forelse($blogs_bangladesh as $blog)
                                ...
                                <div class="content-body">
                                    <header class="entry-header">
                                        ...
                                        <div class="entry-meta">
                                            ...
                                            <span class="posted-on"><time class="entry-date published" datetime="2016-03-01T07:40:25+00:00">{{$blog->created_at->format('d M, Y | h:ia')}}</time></span>
                                        </div>
                                    </header><!-- .entry-header -->
