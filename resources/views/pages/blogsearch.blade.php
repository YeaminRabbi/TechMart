                    ...
                    <div id="primary" class="content-area">
                        <main id="main" class="site-main">
                            ...
                            <article class="post format-standard hentry">
                                ...
                                <div class="media-attachment"><a href="blog-single.html"><img width="870" height="460" src="{{url($blog->image)}}" alt="8"/></a></div>
                           ...
                           @empty
                              <h1 class="text-center">
                                  No Results Found for <strong>{{request()->query('search')}}</strong></h1> 
                        ...
                        <aside id="search-2" class="widget widget_search">
                            <form role="search" method="GET" class="search-form" action="{{route('blog-search')}}">
                                ...
                                <label>
                                    ...
                                    <input type="text" class="search-field" placeholder="Search &hellip;"  name="search" />
                                </label>
