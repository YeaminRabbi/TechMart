        ...
        <div class="container-fluid">
            ...
            @include('alert.messages')
                        <div class="row">
                            <div class="col-12">
                                <div class="card-box">
                                    <h4 class="header-title">Start Writing your blog Tag</h4>
                                    <p class="sub-header">
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div>
                                                <form action="{{route('admin.blogtags.store')}}" enctype="multipart/form-data" method="POST">
                                                    @csrf
                                                    {{method_field('PUT')}}
                                                    <div class="form-group row">
                                                        <label class="col-md-2 col-form-label" for="simpleinput">Enter your Blog Tag Name</label>
                                                        <div class="col-md-10">
                                                            <input type="text" name="tagname" id="simpleinput" class="form-control" placeholder="Write a catchy blog title">
                                                        </div>
                                                    </div>          
                                                    
                                                    <div class="form-group row">
                                                        <label class="col-md-2 col-form-label" for="example-textarea">Enter your Blog Tag Description</label>
                                                        <div class="col-md-10">
                                                            <textarea id="my-editor" name="tagDescription" class="form-control"></textarea>
                                                        </div>
                                                    </div>
