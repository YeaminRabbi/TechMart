                            ...
                            <div class="col-12">
                                <div class="card-box">
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div>
                                                <form action="{{route('admin.terms.update',$terms->id)}}" enctype="multipart/form-data" method="POST">
                                                    @csrf
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-10">
                                                            <textarea id="my-editor" name="description" class="form-control">{{ $terms->description }} </textarea>
