                            ...
                            <div class="col-12">
                                <div class="card-box">
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div>
                                                <form action="{{route('admin.terms.store')}}" enctype="multipart/form-data" method="POST">
                                                    @csrf
                                                    {{method_field('PUT')}}
                                                    ...
                                                    <button type="submit" name="submit" class="btn btn-primary">Create Terms & Conditions</button>
                                                </form>
                                            </div>
                                        </div>
