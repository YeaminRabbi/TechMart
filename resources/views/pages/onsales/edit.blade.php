                            ...
                            <div class="col-12">
                                <div class="card-box">
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div>
                                                <form action="{{route('admin.onsales.update')}}" enctype="multipart/form-data" method="POST">
                                                    @csrf
                                                    ...
                                                    <a href="{{ route('admin.onsales.attribute.edit', $products->id) }}" class="btn btn-warning">
