                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div>
                                                ...
                                                <form action="{{ route('attribute_update_onlsale') }}" method="POST" style="border:1px solid black;padding:15px;margin-top:2px;">
                                                    @csrf
                                                ...
                                                <a  href="{{route('admin.onsales.edit' , $product->id)}}" style="color: white;" class="btn btn-dark m-2">Back </a>
                                            </div>
                                        </div>
                                            ...
                                            <form action="{{ route('attribute_add_features') }}" method="POST">
                                                ...
                                                <div style="margin-top: 30px;">
                                                    <button type="submit" name="submit" class="btn btn-success" >Add Attributes</button>
                                                        ...
                                                        <a  href="{{route('admin.onsales.list')}}"  class="btn btn-dark m-2" > Product List </a>
