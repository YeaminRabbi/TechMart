                        ...
                        <table class="table" cellspacing="0">
                            <thead>
                                <tr>
                                    ...
                                    <th class="product-quantity w-lg-15">Payment</th>
                                    <th class="product-quantity w-lg-15">Payment Status</th>
                                    <th class="product-quantity w-lg-15">Total</th>
                                    <th class="product-quantity w-lg-15">Order Status</th>
                                    <th class="product-quantity w-lg-15">Products</th>
                            ...
                            <tbody>
                             ...
                             @foreach($shippings as $key=> $data)
                                    <tr class="">
                                        ...
                                        <td class="d-none d-md-table-cell">
                                          <a href="{{ route('ViewProducts', $data->id) }}" class="btn btn-success">View</a>
                                        </td>
